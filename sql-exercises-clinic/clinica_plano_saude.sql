...
CREATE TABLE `plano_saude` (
  `cdPlanoSaude` int NOT NULL,
  `dePlanoSaude` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`cdPlanoSaude`)
...
INSERT INTO `plano_saude` VALUES (1,'PlanoSaude 1'),(2,'PlanoSaude 2 '),(3,'PlanoSaude 3');
